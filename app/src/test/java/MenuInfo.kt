object MenuInfo {
    ...
    val burgerSet = arrayListOf(
        Food("싸이버거 세트", 6900, "싸이버거 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!"),
        Food("인크레더블버거 세트", 8000, "인크레더블버거 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!"),
        Food("화이트갈릭버거 세트", 7500, "화이트갈릭버거 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!")
    )
    ...
    val chickenSet = arrayListOf(
        Food("후라이드치킨 세트", 14200, "후라이드치킨 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!"),
        Food("간장마늘치킨 세트", 16200, "간장마늘치킨 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!"),
        Food("맘스양념치킨 세트", 16200, "맘스양념치킨 + 감자튀김 + 콜라 조합! [감자튀김+콜라]를 2300원에!")
    )
    ...
    val sideInfo = arrayListOf(
        ...
        Food("양념감자(중)", 2000, "맘스터치 특유의 양념감자"),
        Food("할라피뇨너겟(4조각)", 2000, "매콤한 맛이 추가된 치킨너겟"),
        Food("양념감자(대)", 3500, "맘스터치 특유의 양념감자"),
        Food("할라피뇨너겟(10조각)", 4500, "매콤한 맛이 추가된 치킨너겟")
    )
}